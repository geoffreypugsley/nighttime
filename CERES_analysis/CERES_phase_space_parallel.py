...
#%%
start_times = pd.date_range("2023-01-01", "2023-12-31 23:00", freq="h")
...
LWP_arr_transposed = np.transpose(LWP_arr,(0,2,1)) ## this has shape (num_start_times, num_trajectories for a given start time, num_time_steps)
...
LWP_arr = LWP_arr_transposed.reshape(-1,LWP_arr_transposed.shape[-1]) ## now shape is (num_start_times*num_trajectories_given_start_time, num_time_steps)
...
plt.title(f'Trajectory flow field')
plt.grid(True)
...
plt.show()
plt.savefig('/disk1/Users/gjp23/outputs/CERES/LWP_Nd_phase_space_2023_12months.png', dpi=300)
...
plt.xlabel('$N_d$ (cm$^{-3}$)')
plt.ylabel('LWP (g m$^{-2}$)')
plt.title('Trajectory flow field colored by SZA')
plt.grid(True)
...
plt.show()
plt.savefig('/disk1/Users/gjp23/outputs/CERES/LWP_Nd_phase_space_SZA_2023_12months.png', dpi=300)
...
plt.savefig('/disk1/Users/gjp23/outputs/CERES/CF_Nd_phase_space_SZA_2023_12months.png', dpi=300)
...
plt.show()
plt.savefig('/disk1/Users/gjp23/outputs/CERES/CF_Nd_phase_space_2023_12months.png', dpi=300)
